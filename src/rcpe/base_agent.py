...
from src.rcpe.config import Settings
from src.rcpe.utils.logger import get_logger
from src.rcpe.utils.helpers import save_json
    ...
    def _create_llm(self, provider: str):
        ...
        if provider == "google":
            ...
            return ChatGoogleGenerativeAI(
                model=self.config.agent.llm_model or "gemini-2.0-flash",  # Verified working Dec 2024
...
if __name__ == "__main__":
    ...
    from src.rcpe.utils.logger import setup_logging
    from langchain.tools import Tool

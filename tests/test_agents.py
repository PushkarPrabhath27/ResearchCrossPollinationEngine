...
class TestBaseAgent:
    ...
    def test_initialization(self):
        ...
        from src.rcpe.agents.base_agent import BaseResearchAgent
...
class TestPrimaryDomainAgent:
    ...
    def agent(self):
        ...
        from src.rcpe.agents.primary_domain_agent import PrimaryDomainAgent
        from src.rcpe.config import get_settings
...
class TestCrossDomainAgent:
    ...
    def agent(self):
        ...
        from src.rcpe.agents.crossdomain_agent import CrossDomainAgent
        from src.rcpe.config import get_settings
...
class TestMethodologyAgent:
    ...
    def agent(self):
        ...
        from src.rcpe.agents.methodology_agent import MethodologyTransferAgent
        from src.rcpe.config import get_settings
...
class TestResourceAgent:
    ...
    def agent(self):
        ...
        from src.rcpe.agents.resource_agent import ResourceFinderAgent
        from src.rcpe.config import get_settings
